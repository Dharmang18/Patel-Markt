...
import { products as staticProducts, categories, Category, categoryEmoji, Product } from '@/lib/products';
...
function ShopContent() {
  ...
  // Pull the live catalogue (reflects admin stock/price changes) and overlay it
  // on top of the static list used for the initial render.
  useEffect(() => {
    let active = true;
    fetch('/api/products')
      .then((r) => r.json())
